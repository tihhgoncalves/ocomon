<?php 
  ...
  */
  ...
  /* Esse projeto é uma continuidade do projeto inicial por Tihh Gonçalves (tiago@tiago.art.br) */

is_file( "./includes/config.inc.php" )
	or die( "<p>Voce precisa configurar o arquivo config.inc.php em OCOMON/INCLUDES/para iniciar o uso do OCOMON!<br>Leia o arquivo <a href='LEIAME.txt'>LEIAME.TXT</a> para obter as principais informações sobre a instalação do OCOMON!".
...
// 		$conec->conecta('MYSQL') ;
		...
		$execStyle = mysql_query($qryStyle) or die('ERRO NA TENTATIVA DE RECUPERAR AS INFORMA��ES DE ESTILOS!<BR>'.$qryStyle);
...
var GLArray = new Array();
	...
	function valida(){
		...
		var ok = validaForm('idLogin','ALFAFULL','Usu�rio',1)
